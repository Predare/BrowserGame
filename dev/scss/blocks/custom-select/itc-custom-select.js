class ItcCustomSelect {
    ...
    _updateOption(el) {
        ...
        var icon = `<img src="${this._el.dataset.icon}" />`;
        var text = `<span > ${elOption.textContent} </span>`;
        this._elToggle.innerHTML = `<div class="itc-select__toggle__content"> ${icon + text} </div>`;
